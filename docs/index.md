...
description: |-
  Resolve certificate chains, generate CSRs, and encode PKCS#12/PKCS#7 bundles.
---

# CertKit Provider

Resolve and verify TLS certificate chains, generate Certificate Signing Requests, and encode certificates into PKCS#12 and PKCS#7 bundles.
...
- **CSR generation**: Generate a CSR that copies Subject and SANs from an existing certificate, for renewal workflows
...
- [`certkit_cert_request`](data-sources/cert_request.md) -- Generate a CSR from a certificate
- [`certkit_pkcs12`](data-sources/pkcs12.md) -- Encode a PKCS#12/PFX bundle
- [`certkit_pkcs7`](data-sources/pkcs7.md) -- Encode a PKCS#7/P7B bundle
